...
const Home = () => {
    return (
        <>
            {/* Hero Section  */}
            <section className='hero-section flex justify-between items-center mt-10 max-lg:flex-col px-20 max-sm:px-7 w-full'>
                <div className='flex flex-col gap-4 items-start lg:w-1/2'>
                    ...
                    <button className='bg-(--color-primary) px-5 py-2 text-lg font-semibold rounded-full hover:ring-2 hover:ring-(--color-secondary) cursor-pointer transition-all ease-linear'>Find out more</button>
                </div>
            ...
            <section className='flex flex-col items-center justify-evenly gap-3 mt-10 py-10 w-full'>
                ...
                <h2 className='text-5xl font-semibold text-center max-md:text-4xl'>We Offer Best Services</h2>
            ...
            {/* Section 3 */}
            <section className='flex flex-col items-center justify-center gap-3 mt-7 py-10'>
                ...
                <div className='flex items-center flex-wrap justify-center gap-10 mt-10'>
                    <div className='flex flex-col items-center justify-center gap-2 w-72 bg-white shadow-[5px_5px_5px_rgba(0,0,0,0.35)] rounded-2xl transform cursor-pointer group'>
                        <div className='w-full overflow-hidden rounded-xl'>
                            <img src={italyImg} alt='Customization' className='hover:scale-110 overflow-hidden transition-all ease-linear rounded-xl' />
                        </div>
                        <div className='py-5 flex flex-col gap-3 w-full'>
                            <div className='flex items-center justify-between px-3'>
                                <h3 className='text-xl font-semibold text-center'>Italy</h3>
                                <p className='font-semibold'>$30k</p>
                            </div>
                            <div className='flex items-center gap-2 px-3'>
                                <Navigation color='gray' size={20} className='group-hover:rotate-45 transition-transform' />
                                <p className='text-md text-center text-gray-600 font-semibold'>10 days trip</p>
                            </div>
                        </div>
                    </div>
                    <div className='flex flex-col items-center justify-center gap-2 w-72 bg-white shadow-[5px_5px_5px_rgba(0,0,0,0.35)] rounded-2xl transform lg:-translate-y-4 cursor-pointer group'>
                        <div className='w-full overflow-hidden rounded-xl'>
                            <img src={germanyImg} alt='Customization' className='hover:scale-110 overflow-hidden transition-all ease-linear rounded-xl' />
                        </div>
                        <div className='py-5 flex flex-col gap-3 w-full'>
                            <div className='flex items-center justify-between px-3'>
                                <h3 className='text-xl font-semibold text-center'>Germany</h3>
                                <p className='font-semibold'>$45k</p>
                            </div>
                            <div className='flex items-center gap-2 px-3'>
                                <Navigation color='gray' size={20} className='group-hover:rotate-45 transition-transform' />
                                <p className='text-md text-center text-gray-600 font-semibold'>12 days trip</p>
                            </div>
                        </div>
                    </div>
                    <div className='flex flex-col items-center justify-center gap-2 w-72 bg-white shadow-[5px_5px_5px_rgba(0,0,0,0.35)] rounded-2xl transform cursor-pointer group'>
                        <div className='w-full overflow-hidden rounded-xl'>
                            <img src={luxembourgImg} alt='Customization' className='hover:scale-110 overflow-hidden transition-all ease-linear rounded-xl' />
                        </div>
                        <div className='py-5 flex flex-col gap-3 w-full'>
                            <div className='flex items-center justify-between px-3'>
                                <h3 className='text-xl font-semibold text-center'>Luxembourg</h3>
                                <p className='font-semibold'>$100k</p>
                            </div>
                            <div className='flex items-center gap-2 px-3'>
                                <Navigation color='gray' size={20} className='group-hover:rotate-45 transition-transform' />
                                <p className='text-md text-center text-gray-600 font-semibold'>28 days trip</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* Section 4 */}
            <section className="flex items-center justify-evenly max-lg:flex-col gap-5 mt-10 px-20 max-sm:px-7 w-full py-10">
            ...
            {/* Section 5 */}
            <section className="flex justify-center max-lg:flex-col items-center gap-10 px-20 mt-10 py-10 w-full">
                <div className="lg:w-1/2">
                    <h4 className="font-semibold text-gray-600 uppercase">Testimonials</h4>
                    <h2 className="font-bold text-5xl max-md:text-4xl">What People Say <br />About Us.</h2>
            ...
            <section className="my-10">
                <marquee behavior="scroll" direction="left"
                    className="bg-(--color-primary) font-bold text-3xl py-3 px-3">
                    <span className="mx-10">M Aun R</span>
                    <span className="mx-10">Tripzo</span>
                    <span className="mx-10">TravellWithUs</span>
                    <span className="mx-10">Adventure</span>
                    <span className="mx-10">Enjoy</span>
                    <span className="mx-10">Life</span>
                    <span className="mx-10">Fun</span>
                </marquee>
            </section>
            ...
            <section>
                <div className="flex flex-col gap-7 items-center justify-center px-20 py-10 md:py-20 ring-1 ring-gray-300 rounded-tl-[100px] w-10/12 mx-auto bg-[#F9F7FE] mt-20 relative">
                    ...
                    <div className="flex items-center gap-3 flex-wrap justify-center">
                        <input type="email" placeholder="Your email" className="bg-white w-full sm:w-76 text-lg text-gray-500 rounded-xl ring-1 ring-gray-300  outline-none pl-2 py-2" />
                        <button className='bg-(--color-primary) px-7 py-2 text-lg font-semibold rounded-full hover:ring-2 hover:ring-(--color-secondary) cursor-pointer transition-all ease-linear'>Subscribe</button>
                    </div>
            ...
            <footer>
                <section className="flex items-center justify-around max-lg:flex-col max-lg:items-start gap-3 w-full px-20 h-fit py-10 bg-gray-100">
