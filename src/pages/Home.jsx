...
const Home = () => {
    ...
    return (
        <>
            {/* Hero Section  */}
            <section className='hero-section flex items-center min-h-screen px-20 py-10 max-lg:px-7 w-full 2xl:max-w-385 2xl:mx-auto relative'>
            ...
            <footer className="2xl:max-w-385 2xl:mx-auto">
                <section className="flex items-center justify-around max-lg:flex-col max-lg:items-start gap-3 w-full px-10 lg:px-20 h-fit py-10 bg-(--color-tertiary)">
                ...
                <div className="font-semibold text-lg text-center bg-(--color-primary) text-white py-3">Copyright &copy; 2026 - All rights reserved @ Tripzo.</div>
            </footer>
        </>
    )
}
